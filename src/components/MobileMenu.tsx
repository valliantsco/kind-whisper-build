                            ...
                            >
                              <div className="pt-2 pb-3">
                                ...
                                {item.dropdownItems[0]?.image ? (
                                  <>
                                    {/* Section label */}
                                    <div className="flex items-center gap-2 px-4 pt-1 mb-3">
                                      <div
                                    ...
                                    {item.hasCta && (
                                      <motion.button
                                        ...
                                        className="mx-[11px] mb-5 flex items-center gap-3 px-2.5 py-1.5 rounded-2xl cursor-pointer group/quiz active:scale-[0.98] transition-transform duration-150"
                                        style={{
