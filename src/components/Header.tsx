                  ...
                  <>
                    ...
                    <div className="relative flex gap-4">
                      ...
                      >
                        ...
                        {/* CTA card "Ver todos os modelos" with rider image */}
                        {activeItem.hasCta && (
                          <motion.a
                            href="#modelos"
                            ...
                            className="group/cta relative flex-shrink-0 rounded-xl overflow-hidden cursor-pointer"
                            style={{
                              width: "210px",
                              aspectRatio: "3/4",
                          ...
                          >
                            ...
                            <div
                              ...
                              style={{
                                background: "linear-gradient(135deg, hsl(11 81% 57% / 0.12) 0%, transparent 60%)",
                              }}
                            />
