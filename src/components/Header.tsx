...
const NAV_ITEMS: NavItem[] = [
  { label: "Início", href: "/" },
  {
    ...
    dropdownItems: [
      { label: "Bicicletas Elétricas", description: "Conforto, autonomia e liberdade para o dia a dia", href: "/modelos?categoria=bicicletas-eletricas", image: categoryBike, video: "https://ppmoesqgmficvajqbamr.supabase.co/storage/v1/object/public/videos/bicicletas-eletricas.mp4", badge: "Novidade" },
      { label: "Autopropelidos", description: "Mobilidade urbana prática, econômica e compacta", href: "/modelos?categoria=autopropelidos", image: categoryAutopropelido, video: "https://ppmoesqgmficvajqbamr.supabase.co/storage/v1/object/public/videos/autopropelido-v2.mp4", badge: "Mais vendidos" },
      { label: "Scooters Elétricas", description: "Desempenho, conforto e estilo na rotina urbana", href: "/modelos?categoria=scooters-eletricas", image: categoryScooter, video: "https://ppmoesqgmficvajqbamr.supabase.co/storage/v1/object/public/videos/scooters-eletricas.mp4" },
      { label: "Triciclos Elétricos", description: "Mais estabilidade, segurança e praticidade", href: "/modelos?categoria=triciclos-eletricos", image: categoryTricycle, video: "https://ppmoesqgmficvajqbamr.supabase.co/storage/v1/object/public/videos/triciclos-eletricos.mp4" },
      { label: "Utilitários", description: "Eficiência e resistência para o trabalho", href: "/modelos?categoria=utilitarios", image: categoryMotocross, video: "https://ppmoesqgmficvajqbamr.supabase.co/storage/v1/object/public/videos/utilitarios.mp4" },
      { label: "Infantil", description: "Diversão elétrica para momentos de lazer", href: "/modelos?categoria=infantil", image: categoryMotocross, video: "https://ppmoesqgmficvajqbamr.supabase.co/storage/v1/object/public/videos/infantil.mp4" },
                      ...
                      >
                        ...
                        <div className="flex flex-col flex-1 px-5 pt-4 pb-4 gap-3">
                          ...
                          <button
                            ...
                            className="flex items-center gap-3 w-full text-left cursor-pointer bg-transparent border-none p-0 group/whatsapp"
                          >
                            <div
                              className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0"
                              style={{
                            ...
                            >
                              <svg className="w-4 h-4" style={{ color: "hsl(11 81% 57%)" }} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="min-w-0">
                              <p className="text-[8px] font-bold uppercase tracking-[0.15em] text-white/35 mb-0.5">WhatsApp</p>
                              <span className="text-white/80 text-[12px] font-semibold tracking-wide group-hover/whatsapp:text-white transition-colors duration-200">
                                (34) 99284-9900
                              </span>
                            </div>
                          </button>
