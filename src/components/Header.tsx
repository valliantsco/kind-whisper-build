...
const NAV_ITEMS: NavItem[] = [
  { label: "Início", href: "/" },
  {
    ...
    dropdownItems: [
      ...
      { label: "Motos Elétricas", description: "Desempenho, conforto e estilo na rotina urbana", href: "/modelos?categoria=scooters-eletricas", image: categoryScooter, video: "https://ppmoesqgmficvajqbamr.supabase.co/storage/v1/object/public/videos/scooters-eletricas.mp4" },
