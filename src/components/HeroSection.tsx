            ...
            {(() => {
              ...
              return (
                <>
                  ...
                  {/* Headline */}
                  <h1 className="font-display font-black text-2xl sm:text-3xl md:text-4xl lg:text-[2.75rem] text-primary-foreground leading-[1] mb-3 md:mb-3.5 uppercase tracking-tight">
                  ...
                  {/* Subheadline */}
                  <p className="text-[11px] sm:text-xs md:text-sm text-primary-foreground/50 mb-3.5 md:mb-4 max-w-sm leading-relaxed tracking-wide">
                    {slide.subheadline}
                  </p>
                  ...
                  <motion.a
                    ...
                    className="inline-flex items-center justify-center text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.14em] px-5 md:px-7 py-2.5 md:py-3 rounded-lg overflow-visible"
                    style={{
