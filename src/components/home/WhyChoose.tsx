...
const WhyChoose = () => {
  ...
  return (
    ...
    >
      {/* ── Background layers (matching project aesthetic) ── */}
      <div
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 80% 80%, hsl(var(--primary) / 0.04) 0%, transparent 60%)",
          filter: "blur(80px)",
        }}
      />
      <div
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(160deg, hsl(0 0% 100% / 0.02) 0%, transparent 40%, hsl(var(--primary) / 0.02) 100%)",
        }}
      />
      {/* Top light strip */}
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent 10%, hsl(var(--primary) / 0.2) 50%, transparent 90%)",
        }}
      />

      <div className="container mx-auto px-4 relative">
        {/* ── Header — left-aligned editorial (matches Testimonials) ── */}
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  boxShadow: isHovered
                    ? "0 20px 60px -15px hsl(var(--primary) / 0.15), 0 0 0 1px hsl(var(--primary) / 0.08)"
                    : "0 4px 20px -5px hsl(0 0% 0% / 0.2)",
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: `radial-gradient(ellipse at 30% 20%, hsl(var(--primary) / ${
                      isHovered ? 0.08 : 0
                    }) 0%, transparent 70%)`,
                ...
                <div className="relative p-7">
                  ...
                  >
                    ...
                    />
                    <pillar.icon
                      className="w-5 h-5 relative z-10 text-primary transition-colors duration-300"
                    />
                  </motion.div>
                  ...
                  {/* Description */}
                  <p className="text-primary-foreground/40 text-sm leading-relaxed group-hover:text-primary-foreground/55 transition-colors duration-300">
                    {pillar.description}
                  </p>

                  {/* CTA hint */}
                  <motion.div
                    className="flex items-center gap-1.5 mt-5 text-primary"
