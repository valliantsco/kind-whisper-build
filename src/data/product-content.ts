...
export const PRODUCT_CONTENT: Record<string, ProductContent> = {
  ...
  "s3k": {
    ...
    idealFor: [
      {
        icon: "trophy",
        title: "Quem quer o melhor da linha",
        desc: "A S3K reúne a maior potência, a maior autonomia e a maior velocidade do portfólio. É a escolha de quem não aceita menos.",
      },
      {
        icon: "battery",
        title: "Quem precisa de mais autonomia",
        desc: "Com até 85 km por carga, você tem liberdade para uma rotina urbana mais ampla, sem ansiedade de recarga.",
      },
      {
        icon: "gauge",
        title: "Quem valoriza performance",
        desc: "Motor de 3.500W e até 80 km/h entregam uma experiência de pilotagem mais intensa, mais segura e mais prazerosa.",
      },
      {
        icon: "star",
        title: "Quem busca uma proposta premium",
        desc: "Visual esportivo, números superiores e sensação de produto mais exclusivo. A S3K é aspiracional de verdade.",
      },
    ],
    whyChoose: [
      {
        title: "Motor de 3.500W — o mais potente da linha",
        desc: "Arrancada, subidas e ultrapassagens com sobra de força. Você sente a diferença a cada aceleração.",
      },
      {
        title: "85 km de autonomia real",
        desc: "A maior autonomia entre as scooters do portfólio. Mais liberdade para ir e voltar sem se preocupar com recarga.",
      },
      {
        title: "Até 80 km/h de velocidade",
        desc: "Desempenho que acompanha o ritmo da cidade com folga, oferecendo uma experiência de pilotagem mais dinâmica e confiante.",
      },
      {
        title: "Visual esportivo e marcante",
    ...
    dailyBenefits: [
      {
        title: "Liberdade para ir mais longe",
        desc: "Com 85 km de autonomia, sua rotina não fica presa a distâncias curtas. Ida e volta com tranquilidade, dia após dia.",
      },
      {
        title: "Potência que faz diferença",
        desc: "Subidas, arrancadas no semáforo e ultrapassagens seguras. O motor de 3.500W entrega confiança em cada situação.",
      },
      {
        title: "Presença que eleva o padrão",
        desc: "Chegar com a S3K é diferente. O visual esportivo e a proposta premium mudam a percepção de quem vê e de quem pilota.",
      },
      {
        title: "Economia com performance máxima",
        desc: "Toda a potência da linha sem gastar com combustível. Recarga na tomada, sem IPVA e com manutenção simplificada.",
      },
      {
        title: "A escolha que você não supera",
        desc: "Quem escolhe a S3K escolhe o topo. É a satisfação de saber que você tem o melhor que a linha pode oferecer.",
      },
    ],
    urbanContext: {
      title: "Performance premium para a cidade",
      body: "A S3K foi projetada para quem vê a mobilidade elétrica como uma experiência completa — e não apenas como um meio de transporte. Com o motor mais potente, a maior autonomia e a maior velocidade da linha, ela transforma cada trajeto urbano em algo mais intenso, mais livre e mais sofisticado. É a scooter para quem quer dominar a cidade com potência, estilo e a confiança de estar no topo.",
      highlights: [
        "Motor de 3.500W — o mais potente do portfólio",
        "85 km de autonomia para mais liberdade urbana",
        "Velocidade de até 80 km/h para mais dinamismo",
        "Visual esportivo com presença premium",
        "Performance superior em subidas e arrancadas",
        "Experiência de pilotagem de nível superior",
      ],
    },
    specContexts: {
      autonomy:
        "85 km por carga — a maior autonomia da linha, pensada para uma rotina urbana com mais liberdade e menos preocupação com recarga.",
      speed:
      ...
      load:
        "Capacidade de 120 kg, compatível com a proposta robusta e premium da scooter mais completa da linha.",
    },
    differentials: {
    ...
    faq: [
      {
        q: "A S3K é indicada para qual tipo de uso?",
        a: "Para uso urbano de quem quer o máximo em potência, autonomia e performance. Ideal para trajetos diários mais longos, com mais confiança em subidas e mais liberdade de deslocamento.",
      },
      {
      ...
      },
      {
        ...
        a: "Ela reúne os melhores números do portfólio: motor mais potente, maior autonomia, maior velocidade e visual esportivo premium. É o topo da experiência elétrica urbana.",
      },
      {
        q: "Ela é uma boa escolha para quem busca uma opção mais premium?",
        a: "Sim. A S3K é a proposta mais premium e mais completa da linha. Se você quer o melhor conjunto de performance e presença, ela é a escolha natural.",
      },
      {
        q: "Como funciona a recarga?",
        a: "Basta conectar na tomada convencional. A carga completa leva de 6 a 8 horas — ideal para carregar à noite e ter a scooter pronta pela manhã.",
      ...
      },
      {
        ...
        a: "Para quem quer o topo. Se você valoriza potência máxima, maior autonomia, velocidade superior e uma experiência premium de verdade, a S3K é o modelo feito para você.",
      },
    ],
    finalCta: {
